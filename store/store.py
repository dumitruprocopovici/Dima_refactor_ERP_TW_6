...
def start_module():
    ...
    list_options = ["Show table", "Add new record", "Remove record", "Update record", "Games of each manufacturer", "Average amount of games"]
    while True:
        ...
        if option == "1":
            ...
            ui.print_result(get_counts_by_manufacturers(table), "Games available of each manufacturer: ")
        elif option == "6":
            manufacturer = ui.get_inputs(["Please enter manufacturer: "], "")
            ui.print_result(get_average_by_manufacturer(table, manufacturer), "Averege amount of games")
        elif option == "0":
            break
        else:
